...
public class JdbcLendCarRepository implements LendCarRepository {
	...
	public int addBookToCart(int userId, int bookId) {
		...
		int rows=jdbc.update(INSERT_LENDCAR,userId,bookId,lendCarState,lendCarDay);
		return rows;
	}
	...
	private String INSERT_LENDCAR = "insert into lendcar (lendcar_user,lendcar_book,lendcar_state,lendcar_day) values (?,?,?,?) ";
	private String SELECT_LENDCAR = "select s1.lendcar_id,s1.lendcar_user,s1.lendcar_book,s1.lendcar_state,s1.lendcar_day, "
